  ...
  return (
    <Container maxWidth="md" disableGutters>
      ...
      <main>
        ...
        <Box style={{display: 'flex', justifyContent: 'space-between'}}>
          <Box style={{width: '75%'}}>
            <Typography variant="body1" className={classes.bodyParagraph}>
              ...
              {mrd}
              {' '}
              is intended to help people with low vision and those assisting them in choosing an appropriate digital reading display.
            </Typography>
        ...
        <Typography variant="body1" className={classes.bodyParagraph}>This calculator provides customized suggestions for display sizes and print sizes for readers with low vision. Please note that vision status and reading goals may vary among users and these individual differences affect the selection of reading display. Our calculation takes into consideration a range of fonts, but you can also choose a specific font that you prefer to use. The suggestions presented here represent a general guideline and may not be appropriate for some readers.</Typography>

        <Typography variant="body1" className={classes.bodyParagraph}>
          {mrd}
          {' '}
          was developed by Ying-Zi Xiong, Nilsu Atilgan and Gordon E. Legge with programming by Reuben Gardos Reid, at the University of Minnesota. The calculations are based in part on published work:
        </Typography>

        <Card className={classes.bodyParagraph}>
          <CardContent>
            <Typography>
              Atilgan, N., Xiong, Y. Z., &amp; Legge, G. E. (2020). Reconciling print-size and display-size
        ...
        <Typography variant="body1" className={classes.bodyParagraph}>To understand the vision status and reading preferences of our users, as well as to improve our calculator, we will store the reading-related information entered by our users, including visual acuity, critical print size, central vision status, preferred viewing distance and preferred font. The calculator DOES NOT ask for or store any identifiable personal information such as name, age, gender, or IP address.</Typography>
      </main>
