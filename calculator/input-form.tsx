...
export default function InputForm() {
  ...
  const {
    setInputValues, setOutputValues, resetOutputValues, resetInputValues, setShowWarning, setShowMinMaxTable, resetFurtherChoices,
    ...
    >
      {(props) => (
        ...
        >
          ...
          <Box style={{
            marginTop: '1em', marginBottom: '1em', display: 'flex', justifyContent: 'space-between',
          }}
          >
            <TextField
              select
          ...
          <Box style={{marginTop: '1em', marginBottom: '1em'}}>
            ...
            <Box component="span" hidden={!(props.values.selectedViewingDistance === 'Custom')}>
              <TextField
                required
